$(function () {
	...
	var options = {
		...
		xaxis: {
			categories: ['8시', '9시', '10시', '11시', '12시', '13시', '14시', '15시', '16시', '17시', '18시', '19시'],
		},
		title: {
			text: '',
			align: 'left',
	...
	var options = {
		...
		xaxis: {
			categories: ['3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월'],
		},
		yaxis: {
			title: {
				text: '개수'
	...
	var options = {
		...
		legend: {
			...
			fontSize: '10px',   // 범례 텍스트 크기
			//fontWeight: 'bold', // 범례 텍스트 굵기
			//labels: {
			//  colors: ['#000000', '#FF0000'] // 각 항목별 색상
			//}
		  },
		responsive: [{
			breakpoint: 480,
